      ...
      <section class="px-6 py-6 md:px-8 md:py-8 flex flex-col justify-center">
        <div class="space-y-5">
          ...
          <div class="space-y-3">
            <button
              type="button"
              class="group w-full inline-flex items-center justify-center gap-3 rounded-xl border border-hwhub-border bg-white px-4 py-2.5 text-sm font-medium text-hwhub-body shadow-sm transition hover:bg-hwhub-surface-subtle hover:shadow focus:outline-none focus:ring-2 focus:ring-hwhub-primary/40 disabled:opacity-60"
