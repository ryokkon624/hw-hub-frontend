...
<template>
  ...
  <div v-if="!forcePill" class="md:hidden">
    <button
      type="button"
      class="flex items-center gap-1.5 px-2 py-1 rounded-full border border-hwhub-border-subtle bg-hwhub-surface-card shadow-sm hover:shadow-md transition-all active:scale-95 group"
      :class="buttonClass"
