<template>
  <section class="space-y-1">
    ...
    <button
      v-else
      type="button"
      class="w-full rounded-xl border border-hwhub-border px-3 py-2 flex items-center justify-between bg-hwhub-surface-card text-sm shadow-sm hover:bg-hwhub-surface transition"
      @click="open = true"
    >
